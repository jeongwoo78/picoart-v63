...
export const masterworkNameMapping = {
  ...
  'campbell\'s soup cans': 'warhol-soup', 'soup cans': 'warhol-soup', '캠벨 수프': 'warhol-soup',
...
export const warholMasterworks = {
  ...
  'warhol-soup': {
    ...
    prompt: 'Andy Warhol "Campbell\'s Soup Cans" (1962), grid pattern repeated soup can images, red white color scheme, graphic pop art aesthetic.',
    feature: '반복, 상품'
  }
};

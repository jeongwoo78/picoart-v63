...
export const ARTIST_STYLES = {
  ...
  // 🔥 야수파 (Fauvism)
  // ========================================
  'matisse': GENDER_RULE + 'Transform this into an oil painting by Henri Matisse, Matisse Fauvist art style. The face and body must have unrealistic bold colors directly on the skin including green on the forehead, red on the cheeks, purple on the jaw and yellow highlights. Apply pure unmixed primary colors that clash and vibrate against each other with completely flat areas having no shadows, shading or depth. Use simplified forms with details removed and bold dark outlines separating color areas. Apply rough fast Fauvist brushstrokes visible on face and body with brush direction showing. Do not blend or create smooth transitions, maintaining a 2D decorative feeling. Include very thick visible brushstrokes of 20mm or thicker.' + PAINT_TEXTURE,
  ...
  // 😱 표현주의 (Expressionism)
  // ========================================
  'munch': GENDER_RULE + 'Transform this into an oil painting by Edvard Munch, Munch Expressionist art style, with intense psychological emotional depth. Capture The Scream style existential anxiety atmosphere with wavy distorted flowing lines in the background. Apply haunting symbolic colors including blood red sky, sickly yellows and deep blues with raw emotional vulnerability and swirling anxious energy. Use visible brushwork with paint texture. Include very thick visible brushstrokes of 20mm or thicker.' + PAINT_TEXTURE,
  ...
  'warhol': GENDER_RULE + 'Transform this into Pop Art by Andy Warhol, Warhol Pop Art style, creating a 2x2 four-panel grid layout. The exact same person or object from the original photo must be repeated 4 times, once in each quadrant. Each of the 4 panels must have a different bold neon color scheme including hot pink, cyan, yellow, orange, electric blue, lime green or turquoise. Apply high contrast silkscreen printing effect with flat graphic colors having no gradients. Do not draw Marilyn Monroe - only draw the person from the original photo. Use visible ink texture and print imperfections. This must look like authentic Pop Art, NOT a photograph, NOT 3D, NOT digital.',

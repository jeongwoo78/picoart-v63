...
export const ARTIST_STYLES = {
  ...
  // 🔥 야수파 (Fauvism)
  // ========================================
  'matisse': GENDER_RULE + 'Transform into an oil painting by Henri Matisse, Matisse Fauvist art style. CRITICAL: Apply BOLD FLAT COLOR AREAS with STRONG DARK OUTLINES. Face must have UNREALISTIC COLORS - bright RED or ORANGE patches on cheeks, GREEN or BLUE shadows. Use PURE SATURATED PRIMARY COLORS - vivid reds, yellows, blues, greens that CLASH and VIBRATE. FLAT 2D DECORATIVE style with NO realistic shading, NO gradients. Background must have BOLD DECORATIVE PATTERNS or flat color blocks. Simplify forms with CURVED FLOWING LINES. Include very thick visible brushstrokes of 25mm or thicker.' + PAINT_TEXTURE,
  
  'derain': GENDER_RULE + 'Transform into an oil painting by André Derain, Derain Fauvist art style. CRITICAL: Use WILD UNNATURAL COLORS - orange sky, blue trees, green faces, purple shadows. Apply BOLD FLAT COLOR PATCHES with visible brushstrokes. Strong color contrasts with pure unmixed pigments. Energetic rough brushwork throughout. Include very thick visible brushstrokes of 25mm or thicker.' + PAINT_TEXTURE,
  
  'vlaminck': GENDER_RULE + 'Transform into an oil painting by Maurice de Vlaminck, Vlaminck Fauvist art style. CRITICAL: Apply VIOLENT EXPLOSIVE COLORS with AGGRESSIVE brushwork. Use the most INTENSE saturated colors - fiery reds, electric blues, acid greens. THICK IMPULSIVE brushstrokes showing raw emotional energy. Van Gogh-influenced passionate intensity. Include very thick visible brushstrokes of 25mm or thicker.' + PAINT_TEXTURE,

  // ========================================
  // 😱 표현주의 (Expressionism)
  // ========================================
  'munch': GENDER_RULE + 'Transform into an oil painting by Edvard Munch, Munch art style. CRITICAL MUNCH REQUIREMENTS: Apply WAVY DISTORTED UNDULATING HORIZONTAL LINES flowing through ENTIRE sky and background like The Scream - lines must CURVE and FLOW like liquid melting reality. Create PALE GHOSTLY SICKLY skin with greenish or yellowish undertones - NOT healthy pink skin. Use BLOOD RED, BURNT ORANGE, and DEEP NAVY BLUE color palette. Background MUST be DISTORTED with sinuous wavelike curves - NOT sharp, NOT realistic. Apply DARK OUTLINES around figure, hair, and features. Apply THICK VISIBLE BRUSHSTROKES of 25mm+ throughout. Face and skin must look HAUNTED and ANXIOUS. Absolutely NOT a photograph, NOT 3D, NOT digital, NOT smooth realistic skin.' + PAINT_TEXTURE,
  
  'kirchner': GENDER_RULE + 'Transform into an oil painting by Ernst Ludwig Kirchner, Kirchner Expressionist art style. CRITICAL: Apply ANGULAR JAGGED forms with ELONGATED SHARP features. Faces must be MASK-LIKE and SIMPLIFIED with exaggerated angular shapes. Use BOLD CLASHING COLORS - acid GREEN, hot PINK, electric BLUE, harsh ORANGE, deep RED. Apply GEOMETRIC COLOR BLOCKS with BLACK OUTLINES separating areas. Die Brücke German Expressionist raw primitive intensity. FLAT COLOR PLANES with angular brushstrokes. Urban tension and psychological alienation. Include very thick visible brushstrokes of 25mm or thicker.' + PAINT_TEXTURE,
  
  'kokoschka': GENDER_RULE + 'Transform into an oil painting by Oskar Kokoschka, Kokoschka Expressionist art style. CRITICAL: DISTORT facial features with ANGULAR EXAGGERATED forms. Apply VIOLENT TURBULENT BRUSHWORK with paint scraped and slashed. Use HARSH ACIDIC COLORS - sickly greens, bruised purples, feverish reds. Face must show PSYCHOLOGICAL TENSION with warped features. Background CHURNING with NERVOUS ENERGY. Include very thick visible brushstrokes of 25mm or thicker.' + PAINT_TEXTURE,
  ...
  'chagall': GENDER_RULE + 'Transform into a dreamlike painting by Marc Chagall, Chagall art style. CRITICAL: Apply SOFT PASTEL COLORS - lavender, pale blue, rose pink, soft yellow. Create DREAMY FLOATING atmosphere with tilted village houses in background. Figures should have ROUNDED SOFT FACES with CLOSED or DREAMY EYES. Use GENTLE CURVED LINES throughout. NOSTALGIC ROMANTIC mood with poetic lyrical quality. Soft feathery brushstrokes. Jewish folklore dreamscape elements. Everything should feel GENTLE, SOFT, DREAMLIKE. Include visible brushwork of 25mm or thicker.' + PAINT_TEXTURE,
